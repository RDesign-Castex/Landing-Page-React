      ...
      <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16">
        <div className="flex flex-col gap-8">
          <h1 className="text-5xl xl:text-7xl font-bold xl:leading-[7.5rem]">
            Diseñamos tu Sitio Web de Exelencia{" "}
          ...
          Ayudamos a encontrar soluciones con intitutivas y de acuerdo con el cliente,
          objetivos de negocios. Brindamos servicios de alta calidad.
          </p>
